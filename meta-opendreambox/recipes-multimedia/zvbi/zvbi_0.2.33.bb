...
SRC_URI = "${SOURCEFORGE_MIRROR}/zapping/${BP}.tar.bz2 \
           ...
           file://0004-page-catching-add-pagenumber.patch \
           file://0005-page-catching-search-only-current-page.patch \
           file://0006-fix-sky-not-working.patch \
           file://0007-fix-top-navigation.patch"
