...
GST_SRCREV = "${@base_conditional('OPENDREAMBOX_GST_VERSION', '0.10', '351a9aad7ac0d5122b97ab7c2b4ef184392e9124', '8bf413af5673ca77dee4b077562176eddc15e668', d)}"
SRCREV = "${@opendreambox_srcrev('${GST_SRCREV}', d)}"
